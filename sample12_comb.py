...
# 1. 열병합 : hstack((array1, array2)), concatenate((array1, array2), axis=1), column_stack((arr, arr2))
...
# 2. 행병합 : vstack((array1, array2)), concatenate((array1, array2), axis=0), row_stack((arr, arr2))
